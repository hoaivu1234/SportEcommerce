...
export function toQueryParams(state: ProductFilterState): Params {
  ...
  if (state.categoryId != null)   p['categoryId'] = state.categoryId;
 ...
 * the ProductService expects. Sends sortBy/sortDir as separate params
 * matching the backend's @RequestParam expectations.
 */
